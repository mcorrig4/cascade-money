...
test('only authored site shots prefetch imagery; opening and California remain on the globe', () => {
  ...
  // Shot 10 ("New York") is cut (scene-11-delete pass, 2026-09-13): it is no
  // longer an authored shot, so it gets no site at all. Shots 19 and 12 open
  // the fifth-avenue site themselves and take full blend immediately.
