...
declare global {
  ...
  interface Window {
    ...
    __cascade?: {
      ...
      tiles: () => { site: 'apple-park' | 'fifth-avenue' | null; ready: boolean; failed: boolean; progress: number; visibleTiles: number; opacity: number; ground: number | null; modelSize: [number, number, number] | null };
