...
or local Foundry runs; public testnet time is never accelerated. Shot 11 uses [architecture.svg](architecture.svg), a hand-laid counterpart of this Mermaid block
generated by `contracts/scripts/render-architecture.mjs` without Chrome. Rasterize the SVG externally.
