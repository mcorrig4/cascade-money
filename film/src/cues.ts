...
export const CUE_PHRASES: Record<number, CuePhrase[]> = {
  ...
  2: [
    ...
    {cue: 'payment-terms', phrase: 'payment terms'},
    {cue: 'promises-fallback', phrase: 'promises'},
    {cue: 'promises-word', phrase: 'promises'},
  ...
  4: [
    ...
    {cue: 'not-as-cash', phrase: 'not as cash'},
    {cue: 'not-cash', phrase: 'cash'},
    {cue: 'as-dollar-with-date', phrase: 'as a dollar with a date'},
  ],
  5: [
