...
if [[ "$MODE" == "draft" ]]; then
  # Scene 3 was cut — iterate the same 16 surviving scene numbers as the
  # CONCAT_LIST loop above, not a contiguous 1..17 range.
  SURVIVING_SCENES=(01 02 04 05 06 07 08 09 10 11 12 13 14 15 16 17)
