...
# (New York cut, 2026-09-13 04:15 EDT) to exist (run
...
# The film is 12 scenes (New York cut, 2026-09-13 04:15 EDT) — concat the
...
if [[ "$MODE" == "draft" ]]; then
  # The film is 12 scenes (New York cut, 2026-09-13 04:15 EDT) — iterate the
